  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <p className="text-lg text-slate-600 mb-10">
        How we research UK car raffle and competition sites &mdash; and what we will and won&rsquo;t say.
      </p>
      ...
      <div className="prose-custom space-y-8">
        <section>
          ...
          <p>
            ...
            say, trust signals, and &mdash; importantly &mdash; what to watch out for. We don&rsquo;t write
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              the UK government &mdash; the most reliable source for legal entity information.
            </li>
            <li>
            ...
            <li>
              <strong>The operator&rsquo;s own website and terms:</strong> Competition model, ticket
            ...
            <li>
              ...
              the government&rsquo;s voluntary code for prize draw operators (May 2026). Signing is not
            ...
            <li>
              ...
              and any concerns that don&rsquo;t surface in official channels.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            All reviews are written by a human &mdash; not generated by AI. CarRaffleOdds is a small
        ...
        <section>
          ...
          <p>
            ...
            are sorted by year established &mdash; not by commission rate. The same principle applies
        ...
        <section>
          ...
          <ul>
            <li>Write fake urgency (&ldquo;Only 3 tickets left!&rdquo; or countdown resets)</li>
            ...
            <li>Auto-publish reviews &mdash; every page is approved by a human before it goes live</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            standings change significantly. Each review page carries a &ldquo;Last research update&rdquo;
